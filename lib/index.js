...
//
// - publishOperationsToDriver  This is used to determine whether to publish submitted operations
//     to pub sub driver.
function Livedb(options) {
  ...
  this.publishOperationsToDriver = typeof options.publishOperationsToDriver === 'undefined' ? true : options.publishOperationsToDriver;
};
        ...
        self.driver.atomicSubmit(cName, docName, opData, options, function(err) {
          if (err === 'Transform needed') {
            ...
            self._writeSnapshotAfterSubmit(cName, docName, snapshot, opData, options, function(err) {
              ...
              if (self.publishOperationsToDriver && self.driver.postSubmit)
                self.driver.postSubmit(cName, docName, opData, snapshot);
