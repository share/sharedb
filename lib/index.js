...
//
// If you don't provide a driver in an options object, livedb will default to
// using an inprocessDriver instance, which is created & configured automatically.
//
// Other options:
//
...
Livedb.prototype.bulkSubscribe = function(requests, callback) {
  ...
  if (!hasProjections) {
    ...
    this.driver.bulkSubscribe(requests, function(err, r) {
      for (var cName in r) {
