...
Livedb.prototype._getVersionKey = function (cName, docName) {
  return cName+ '.' + docName + ' v';
};

Livedb.prototype._getOpLogKey = function (cName, docName) {
  return cName + '.' + docName+ ' ops';
};

Livedb.prototype._getDocOpChannel = function (cName, docName) {
  return cName + '.' + docName;
};

Livedb.prototype._processRedisOps = function (docV, to, result) {
...
Livedb.prototype._logEntryForData = function (opData) {
