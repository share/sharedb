...
// Subscribe to changes on a channel. This is used by livedb's polling query code.
InprocDriver.prototype.subscribeChannel = function(channel, callback) {
  ...
  var self = this;
  stream.once('close', function() {
    self.subscribers.removeListener(channel, listener);
    self._cleanupStream(stream);
  });
