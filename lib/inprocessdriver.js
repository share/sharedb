...
InprocDriver.prototype.postSubmit = function(cName, docName, opData, snapshot) {
  // This is needed for the query code. (Ugh vomit). This has to happen here to make sure the
  // snapshotdb gets updated before queries are run.

  // This is kind of weird, but it works great. Its probably fine polluting the original opData with
  // its docName, but I don't want people to depend on that.
