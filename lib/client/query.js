...
var Query = /** @class */ (function () {
  ...
  Query.prototype.destroy = function (callback) {
    if (this.connection.canSend && this.action === message_actions_1.ACTIONS.querySubscribe) {
      this.connection.send({ a: message_actions_1.ACTIONS.queryUnsubscribe, id: this.id });
    }
