...
Connection.prototype._setState = function(newState, reason) {
  ...
  // Emit the even to all snapshots
 ...
 * @param version (optional) - the version number, or Date of the snapshot to fetch. If an exact version or Date match is
 *   not made, then the next lower version is returned. ie if a document has 6 versions, asking for v7 will return v6. If
 *   ops were submitted at 02:00 and 03:00, then asking for a Date at 02:30 will return the 02:00 version.
...
Connection.prototype.getSnapshot = function(collection, id, version, callback) {
  ...
  var snapshotRequest = new SnapshotRequest(this, collection, id, version, callback);
