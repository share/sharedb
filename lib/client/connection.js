...
var Connection = /** @class */ (function () {
  ...
  Connection.prototype.handleMessage = function (message) {
    ...
    switch (message.a) {
      case message_actions_1.ACTIONS.initLegacy:
      ...
      case message_actions_1.ACTIONS.queryUnsubscribe:
        ...
        return;
      case message_actions_1.ACTIONS.queryUpdate:
  ...
  Connection.prototype.sendFetch = function (doc) {
    return this._sendActions(message_actions_1.ACTIONS.fetch, doc, doc.version);
  };
  Connection.prototype.sendSubscribe = function (doc) {
    return this._sendActions(message_actions_1.ACTIONS.subscribe, doc, doc.version);
  };
  Connection.prototype.sendUnsubscribe = function (doc) {
    return this._sendActions(message_actions_1.ACTIONS.unsubscribe, doc);
  };
  ...
  Connection.prototype.get = function (collection, id) {
    var docs = this.collections[collection] || (this.collections[collection] = Object.create(null));
    var doc = docs[id];
    if (!doc) {
  ...
  Connection.prototype.createFetchQuery = function (collection, q, options, callback) {
    return this._createQuery(
      message_actions_1.ACTIONS.queryFetch,
      collection,
      q,
      options,
      callback,
  ...
  Connection.prototype.createSubscribeQuery = function (collection, q, options, callback) {
    return this._createQuery(
      message_actions_1.ACTIONS.querySubscribe,
      collection,
      q,
      options,
      callback,
  ...
  Connection.prototype._initializeHandshake = function () {
    this.send({
      a: message_actions_1.ACTIONS.handshake,
      id: this.id,
  ...
  Connection.prototype._initialize = function (message) {
    ...
    if (typeof message.id !== 'string') {
      return this.emit(
        'error',
        new ShareDBError(ERROR_CODE.ERR_CLIENT_ID_BADLY_FORMED, 'Client id must be a string'),
      );
    }
    this.id = message.id;
  ...
  Connection.prototype._requestRemotePresence = function (channel) {
    this.send({ a: message_actions_1.ACTIONS.presenceRequest, ch: channel });
  };
