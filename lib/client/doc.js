...
Doc.prototype._transformPresence = function(presence) {
  if (this.pendingOps.length && this.presenceTransformer) {
    return this.presenceTransformer(presence, this.pendingOps)
  } else {
    return presence
  }
}
...
Doc.prototype._otApply = function(op, source) {
  if (op.op) {
    ...
    const presence = op.pr ? this._transformPresence(op.pr) : undefined
