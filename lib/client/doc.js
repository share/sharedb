...
//
// Note that types.defaultType is used inside ingestSnapshot when snapshot.type is omitted.
// If you need to use a different type, populate `snapshot.type` with the OT type you are using.
Doc.prototype.createSnapshot = function() {
  return {
    v: this.version,
    data: this.data,
  };
