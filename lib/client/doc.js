...
function Doc(connection, collection, id) {
  ...
  // Map of src -> presence
  this.presence.received = Object.create(null);
  ...
  this.presence.receivedTimeout = 60000;
  ...
  this.presence.cachedOps = [];
  this.presence.cachedOpsTimeout = 60000;
  ...
  doc.whenNothingPending(function() {
    if (doc.wantSubscribe) {
      doc.unsubscribe(function(err) {
        ...
        doc.presence.received = Object.create(null);
...
Doc.prototype.flush = function() {
  ...
  if (this.subscribed && !this.presence.inflight && this.pendingPresence && !this.hasWritePending()) {
    this.presence.inflight = this.pendingPresence;
...
Doc.prototype.submitPresence = function (data, callback) {
  ...
  if (this._setPresence('', data, true) || this.pendingPresence || this.presence.inflight) {
...
Doc.prototype._pausePresence = function() {
  if (this.presence.inflight) {
    this.pendingPresence =
      this.pendingPresence ?
        this.presence.inflight.concat(this.pendingPresence) :
        this.presence.inflight;
    this.presence.inflight = null;
    this.presence.inflightSeq = 0;
  } else if (!this.pendingPresence && this.presence.current[''] != null) {
    this.pendingPresence = [];
  }
  this.presence.received = Object.create(null);
  this.presence.requestReply = true;
