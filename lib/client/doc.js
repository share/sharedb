 ...
 * @private
 */
Doc.prototype._otApply = function(opData) {
  this.locked = true;
  ...
  if (opData.op) {
    return this.emit('after op', opData.op);
  }
};
...
Doc.prototype.submitOp = function(op, callback) {
  this._submitOpData({op: op}, callback);
};
...
Doc.prototype.create = function(type, data, callback) {
  ...
  this._submitOpData(op, callback);
};
...
Doc.prototype.del = function(callback) {
  ...
  this._submitOpData({del: true}, callback);
};
