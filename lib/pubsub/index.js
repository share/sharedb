...
PubSub.prototype._subscribe = function(channel, callback) {
  process.nextTick(function() {
    callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, '_subscribe PubSub method unimplemented'));
  });
};

PubSub.prototype._unsubscribe = function(channel, callback) {
  process.nextTick(function() {
    callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, '_unsubscribe PubSub method unimplemented'));
  });
};

PubSub.prototype._publish = function(channels, data, callback) {
  process.nextTick(function() {
    callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, '_publish PubSub method unimplemented'));
  });
};
