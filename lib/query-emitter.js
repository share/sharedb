...
var QueryEmitter = /** @class */ (function () {
  function QueryEmitter(request, streams, ids, extra) {
    ...
    this.pollDebounce =
      typeof this.options.pollDebounce === 'number'
        ? this.options.pollDebounce
        : typeof this.db.pollDebounce === 'number'
          ? this.db.pollDebounce
          : streams.length > 1
            ? 1000
            : 0;
    this.pollInterval =
      typeof this.options.pollInterval === 'number'
        ? this.options.pollInterval
        : typeof this.db.pollInterval === 'number'
          ? this.db.pollInterval
          : streams.length > 1
            ? 1000
            : 0;
    this._polling = false;
