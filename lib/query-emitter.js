...
QueryEmitter.prototype._open = function() {
  var emitter = this;
  this._updateCallback = function(err) {
...
QueryEmitter.prototype._update = function(op) {
  ...
  try {
    if (this.db.skipPoll(this.collection, id, op, this.query)) return this._updateCallback();
    if (this.skipPoll(this.collection, id, op, this.query)) return this._updateCallback();
  } catch (err) {
    return this._updateCallback(err);
  }
  if (this.canPollDoc) {
