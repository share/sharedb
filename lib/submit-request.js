...
SubmitRequest.prototype.alreadySubmittedError = function() {
  return {code: ERROR_CODE.OP_ALREADY_SUBMITTED, message: 'Op already submitted'};
};
SubmitRequest.prototype.rejectedError = function() {
  return {code: ERROR_CODE.OP_SUBMIT_REJECTED, message: 'Op submit rejected'};
};
// Fatal client errors:
SubmitRequest.prototype.alreadyCreatedError = function() {
  return {code: ERROR_CODE.DOCUMENT_ALREADY_CREATED, message: 'Invalid op submitted. Document already created'};
};
SubmitRequest.prototype.newerVersionError = function() {
  return {
    code: ERROR_CODE.OP_VERSION_NEWER_THAN_SNAPSHOT,
    message: 'Invalid op submitted. Op version newer than current snapshot'
  };
};
SubmitRequest.prototype.projectionError = function() {
  return {
    code: ERROR_CODE.OP_INVALID_IN_PROJECTION,
...
SubmitRequest.prototype.missingOpsError = function() {
  return {
    code: ERROR_CODE.MISSING_TRANSFORM_OPS,
...
SubmitRequest.prototype.versionDuringTransformError = function() {
  return {code: ERROR_CODE.VERSION_MISMATCH, message: 'Op submit failed. Versions mismatched during op transform'};
};
...
SubmitRequest.prototype.maxRetriesError = function() {
  return {code: ERROR_CODE.MAX_RETRIES, message: 'Op submit failed. Maximum submit retries exceeded'};
};
