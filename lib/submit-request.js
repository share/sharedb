...
SubmitRequest.prototype.alreadySubmittedError = function() {
  return {code: ERROR_CODE.ERR_OP_ALREADY_SUBMITTED, message: 'Op already submitted'};
};
SubmitRequest.prototype.rejectedError = function() {
  return {code: ERROR_CODE.ERR_OP_SUBMIT_REJECTED, message: 'Op submit rejected'};
};
// Fatal client errors:
SubmitRequest.prototype.alreadyCreatedError = function() {
  return {code: ERROR_CODE.ERR_DOC_ALREADY_CREATED, message: 'Invalid op submitted. Document already created'};
};
SubmitRequest.prototype.newerVersionError = function() {
  return {
    code: ERROR_CODE.ERR_OP_VERSION_NEWER_THAN_CURRENT_SNAPSHOT,
    message: 'Invalid op submitted. Op version newer than current snapshot'
  };
};
SubmitRequest.prototype.projectionError = function() {
  return {
    code: ERROR_CODE.ERR_OP_NOT_ALLOWED_IN_PROJECTION,
...
SubmitRequest.prototype.missingOpsError = function() {
  return {
    code: ERROR_CODE.ERR_SUBMIT_TRANSFORM_OPS_NOT_FOUND,
...
SubmitRequest.prototype.versionDuringTransformError = function() {
  return {
    code: ERROR_CODE.ERR_OP_VERSION_MISMATCH_DURING_TRANSFORM,
    message: 'Op submit failed. Versions mismatched during op transform'
  };
};
SubmitRequest.prototype.versionAfterTransformError = function() {
  return {
    code: ERROR_CODE.ERR_OP_VERSION_MISMATCH_AFTER_TRANSFORM,
...
SubmitRequest.prototype.maxRetriesError = function() {
  return {
    code: ERROR_CODE.ERR_MAX_SUBMIT_RETRIES_EXCEEDED,
    message: 'Op submit failed. Exceeded max submit retries of ' + this.maxRetries
  };
};
