...
var SubmitRequest = /** @class */ (function () {
  ...
  SubmitRequest.prototype._fetchCreateOpVersion = function (callback) {
    ...
    this.backend.db.getCommittedOpVersion(
      this.collection,
      this.id,
      this.snapshot,
      this.op,
  ...
  SubmitRequest.prototype.noOpError = function () {
    return new ShareDBError(ERROR_CODE.ERR_NO_OP, 'Op is a no-op. Skipping apply.');
  };
