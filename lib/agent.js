...
Agent.prototype._handleMessage = function(request, callback) {
  try {
    ...
    switch (request.a) {
      ...
      case 'sv':
        return this._getSnapshot(request.c, request.d, request.v, request.ts, callback);
      default:
...
Agent.prototype._getSnapshot = function (collection, id, version, timestamp, callback) {
  this.backend.getSnapshot(this, collection, id, version, timestamp, callback);
};
