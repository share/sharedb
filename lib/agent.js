...
Agent.prototype._subscribeToQuery = function(emitter, queryId, collection, query) {
  ...
  emitter.onExtra = function(extra) {
    agent.send({a: ACTIONS.queryReply, id: queryId, extra: extra});
  };
  ...
  emitter.onDiff = function(diff) {
    ...
    agent.send({a: ACTIONS.queryReply, id: queryId, diff: diff});
  };
...
Agent.prototype._checkRequest = function(request) {
  if (request.a === ACTIONS.queryFetch || request.a === ACTIONS.querySubscribe || request.a === ACTIONS.queryUnsubscribe) {
