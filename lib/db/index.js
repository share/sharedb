...
DB.prototype.commit = function(collection, id, op, snapshot, options, callback) {
  callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, 'commit DB method unimplemented'));
};

DB.prototype.getSnapshot = function(collection, id, fields, options, callback) {
  callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, 'getSnapshot DB method unimplemented'));
};
...
DB.prototype.getOps = function(collection, id, from, to, options, callback) {
  callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, 'getOps DB method unimplemented'));
};
...
DB.prototype.query = function(collection, query, fields, options, callback) {
  callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, 'query DB method unimplemented'));
};
...
DB.prototype.queryPollDoc = function(collection, id, query, options, callback) {
  callback(new ShareDBError(ERROR_CODE.NOT_IMPLEMENTED, 'queryPollDoc DB method unimplemented'));
};
