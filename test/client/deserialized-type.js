...
var NodeSh = /** @class */ (function () {
    function NodeSh(value, next) {
        this.value = value;
        this.next = next;
        this.value = value;
        this.next = next || null;
    }
    NodeSh.prototype.at = function (index) {
        var node = this;
        while (index--) {
            node = node.next;
        }
    ...
    ;
    NodeSh.prototype.insert = function (index, value) {
        if (index === 0) {
            return new NodeSh(value, this);
        }
        var previous = this.at(index - 1);
        var node = new NodeSh(value, previous.next);
        previous.next = node;
        return this;
    };
    ;
    ...
    NodeSh.prototype.toJSON = function () {
        var out = [];
