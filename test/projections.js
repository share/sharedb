...
describe('projection utility methods', function () {
    describe('projectSnapshot', function () {
        ...
        it('empty object filters out all properties', function () {
            test({}, { type: type, data: undefined }, { type: type, data: undefined });
            test({}, { type: type, data: null }, { type: type, data: null });
            test({}, { type: type, data: {} }, { type: type, data: {} });
            test({}, { type: type, data: { a: 2 } }, { type: type, data: {} });
        });
        it('works the same way on null or undefined type', function () {
            test({}, { type: null, data: undefined }, { type: null, data: undefined });
            test({}, { type: null, data: null }, { type: null, data: null });
            test({}, { type: null, data: {} }, { type: null, data: {} });
            test({}, { type: null, data: { a: 2 } }, { type: null, data: {} });
            test({}, { data: undefined }, { data: undefined });
            test({}, { data: null }, { data: null });
            test({}, { data: {} }, { data: {} });
            test({}, { data: { a: 2 } }, { data: {} });
        });
        it('filters out any non-truthy properties', function () {
            test({ x: true }, { type: type, data: { x: 2 } }, { type: type, data: { x: 2 } });
            test({ x: true }, { type: type, data: { x: [1, 2, 3] } }, { type: type, data: { x: [1, 2, 3] } });
            test({ x: true }, { type: type, data: { a: 2, x: 5 } }, { type: type, data: { x: 5 } });
        });
        it('returns null for non-object snapshot data', function () {
            test({ x: true }, { type: type, data: undefined }, { type: type, data: undefined });
            test({ x: true }, { type: type, data: null }, { type: type, data: null });
            test({ x: true }, { type: type, data: [] }, { type: type, data: null });
            test({ x: true }, { type: type, data: 4 }, { type: type, data: null });
            test({ x: true }, { type: type, data: 'hi' }, { type: type, data: null });
        });
    });
    describe('projectOp', function () {
        ...
        it('passes src/seq into the projected op', function () {
            test({}, { src: 'src', seq: 123, op: [] }, { src: 'src', seq: 123, op: [] });
        });
        describe('op', function () {
            it('filters components on the same level', function () {
                test({}, { op: [] }, { op: [] });
                test({}, { op: [{ p: ['x'], na: 1 }] }, { op: [] });
                test({ x: true }, { op: [{ p: ['x'], na: 1 }] }, { op: [{ p: ['x'], na: 1 }] });
                test({ y: true }, { op: [{ p: ['x'], na: 1 }] }, { op: [] });
                test({ x: true, y: true }, { op: [{ p: ['x'], od: 2, oi: 3 }, { p: ['y'], na: 1 }] }, { op: [{ p: ['x'], od: 2, oi: 3 }, { p: ['y'], na: 1 }] });
                test({ y: true }, { op: [{ p: ['x'], od: 2, oi: 3 }, { p: ['y'], na: 1 }] }, { op: [{ p: ['y'], na: 1 }] });
                test({ x: true }, { op: [{ p: ['x'], od: 2, oi: 3 }, { p: ['y'], na: 1 }] }, { op: [{ p: ['x'], od: 2, oi: 3 }] });
            });
            it('filters root ops', function () {
                test({}, { op: [{ p: [], od: { a: 1, x: 2 }, oi: { x: 3 } }] }, { op: [{ p: [], od: {}, oi: {} }] });
                test({ x: true }, { op: [{ p: [], od: { a: 1, x: 2 }, oi: { x: 3 } }] }, { op: [{ p: [], od: { x: 2 }, oi: { x: 3 } }] });
                test({ x: true }, { op: [{ p: [], od: { a: 1, x: 2 }, oi: { z: 3 } }] }, { op: [{ p: [], od: { x: 2 }, oi: {} }] });
                test({ x: true, a: true, z: true }, { op: [{ p: [], od: { a: 1, x: 2 }, oi: { z: 3 } }] }, { op: [{ p: [], od: { a: 1, x: 2 }, oi: { z: 3 } }] });
                test({ x: true }, { op: [{ p: [], na: 5 }] }, { op: [] });
                // If you make the document something other than an object, it just looks like null.
                test({ x: true }, { op: [{ p: [], od: { a: 2, x: 5 }, oi: [] }] }, { op: [{ p: [], od: { x: 5 }, oi: null }] });
            });
            it('allows editing in-property fields', function () {
                test({}, { op: [{ p: ['x', 'y'], na: 1 }] }, { op: [] });
                test({ x: true }, { op: [{ p: ['x', 'y'], na: 1 }] }, { op: [{ p: ['x', 'y'], na: 1 }] });
                test({ x: true }, { op: [{ p: ['x'], na: 1 }] }, { op: [{ p: ['x'], na: 1 }] });
                test({ y: true }, { op: [{ p: ['x', 'y'], na: 1 }] }, { op: [] });
            });
        });
        describe('create', function () {
            ...
            it('strips data in creates', function () {
                test({ x: true }, { create: { type: type, data: { x: 10 } } }, { create: { type: type, data: { x: 10 } } });
                test({ x: true }, { create: { type: type, data: { y: 10 } } }, { create: { type: type, data: {} } });
            });
        });
    });
    describe('isSnapshotAllowed', function () {
        ...
        it('returns true iff projectSnapshot returns the original object', function () {
            test({ x: true }, { type: type, data: { x: 5 } });
            test({}, { type: type, data: { x: 5 } });
            test({ x: true }, { type: type, data: { x: { y: true } } });
            test({ y: true }, { type: type, data: { x: { y: true } } });
            test({ x: true }, { type: type, data: { x: 4, y: 6 } });
        });
    ...
    describe('isOpAllowed', function () {
        ...
        it('works with create ops', function () {
            test({}, { create: { type: type, data: null } });
            test({ x: true }, { create: { type: 'something else' } });
            test({ x: true }, { create: { type: type, data: {} } });
            test({ x: true }, { create: { type: type, data: { x: 5 } } });
            test({ x: true }, { create: { type: type, data: { y: 5 } } });
        });
        ...
        it('works with ops', function () {
            test({ x: true }, { op: [{ p: ['x'], na: 1 }] });
            test({ y: true }, { op: [{ p: ['x'], na: 1 }] });
            test({}, { op: [{ p: ['x'], na: 1 }] });
            test({ x: true }, { op: [{ p: ['x'], na: 1 }, { p: ['y'], na: 1 }] });
            test({ x: true }, { op: [{ p: [], oi: { y: 1 } }] });
        });
    });
});
function clone(obj) {
