...
var QueryEmitter = /** @class */ (function () {
    ...
    QueryEmitter.prototype._update = function (op) {
        ...
        try {
            if (this.db.skipPoll(this.collection, id, op, this.query))
                return this._defaultCallback();
            if (this.skipPoll(this.collection, id, op, this.query))
                return this._defaultCallback();
        }
        catch (err) {
    ...
    QueryEmitter.prototype.queryPoll = function (callback) {
        ...
        this.db.queryPoll(this.collection, this.query, this.options, function (err, ids, extra) {
            if (err)
                return emitter._finishPoll(err, callback, pending);
    ...
    // are dropped.
    QueryEmitter.prototype.onError = function () {
        var args = [];
    ...
    ;
    QueryEmitter.prototype.onDiff = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ;
    QueryEmitter.prototype.onExtra = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ;
    QueryEmitter.getInserted = function (diff) {
        var inserted = [];
    ...
    QueryEmitter.mapDiff = function (idsDiff, snapshotMap) {
        var diff = [];
