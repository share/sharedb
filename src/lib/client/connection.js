...
var Connection = /** @class */ (function (_super) {
    ...
    function Connection(socket) {
        ...
        _this.agent = null;
        _this.debug = false;
        _this.state = Connection.connectionState(socket);
        _this.bindToSocket(socket);
        return _this;
    }
    Connection.connectionState = function (socket) {
    ...
    Connection.prototype._setState = function (newState, reason) {
        ...
        if ((newState === 'connecting' && this.state !== 'disconnected' && this.state !== 'stopped' && this.state !== 'closed') ||
    ...
    Connection.prototype.hasPending = function () {
        return !!(this._firstDoc(Connection.hasPending) ||
            this._firstQuery(Connection.hasPending));
    };
    ;
    Connection.hasPending = function (object) {
    ...
    ;
    Connection.hasWritePending = function (object) {
