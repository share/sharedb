...
class Doc {
   ...
   * @param callback
   */
  ingestSnapshot(snapshot, callback) {
  ...
  _emitResponseError(err, callback) {
  ...
  _handleSubscribe(error, snapshot) {
  ...
  _queueSubscribe(wantSubscribe, callback) {
   ...
   */
  submitOp(component, options, callback) {
