 ...
 */
class MemoryMilestoneDB extends MilestoneDB {
  _milestoneSnapshots;
  ...
  constructor(options) {
    ...
    this._milestoneSnapshots = Object.create(null);
  }
  ...
  _findMilestoneSnapshot(collection, id, breakCondition, callback) {
    if (!collection) {
  ...
  _getMilestoneSnapshotsSync(collection, id) {
    var collectionSnapshots = this._milestoneSnapshots[collection] ||
