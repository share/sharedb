...
class MemoryDB extends DB {
   ...
   */
  _querySync(snapshots) {
    return {snapshots: snapshots};
  }

  _writeOpSync(collection, id, op) {
   ...
   */
  _writeSnapshotSync(collection, id, snapshot) {
  ...
  _getSnapshotSync(collection, id, includeMetadata) {
